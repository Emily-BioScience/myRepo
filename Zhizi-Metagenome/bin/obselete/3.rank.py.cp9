...
# def selectSamplesNew(infile, tablefile, logfile, outfile, clusterfile, removefile=''):
def selectSamplesNew(infile, tablefile, clusterfile, removefile=''):
    # read raw data
    data = pd.read_csv(infile, sep="\t")
    ...
    # summary.to_csv(outfile, sep="\t", index=False)
    # K-means clustering
    summary = kmeans_clustering(summary)
...
if __name__ == '__main__':
    ...
    # logfile = '../output/2019.09.allSamples-withStool.txt'
    # outfile = '../output/2019.09.selectSamples.txt'
    # outfile = '../output/2019.09.selectSamples-withStool.txt'
    # k-means results
    clusterfile = '../output/2019.09.selectSamples-withStool-kmeans.txt'
    selectSamplesNew(infile, tablefile, clusterfile, removefile)
    # selectSamplesNew(infile, tablefile, logfile, outfile, clusterfile, removefile)
